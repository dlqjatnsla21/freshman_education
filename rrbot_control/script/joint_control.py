...
def forward_kinematics(th1, th2, th3):
    ...
    print("Target Position Values :", H[0,3], H[1,3], H[2,3])


while not rospy.is_shutdown():
    th1, th2, th3 = input("Enter the target joint position : ").split()
    th1, th2, th3 = float(th1)*m.pi/180, float(th2)*m.pi/180, float(th3)*m.pi/180
